...
class CardController extends Controller {
	 ...
	 public function index(Card $card , Request $request)
	{
	 $cards = $card
		 ...
		 ->select(array('cards.id as cardID','player.name as player_name','match.id as match_id',
		 'referee.name as referee_name','cards.color as color','cards.comment as comment','cards.time as time'))
		->orderBy('cardID')->get();
		 ...
		 if($request->ajax())
			 ...
			 $matches  = $match
					...
					->get();			 $referees=Referee::lists('name','id');
