    ...
    <div class="col-sm-8 ">
      <div class="row">
        ...
        <div class="blog-post-body col-sm-12">
          <h3 class="text-primary"><a href="post-details.html">شاكيري يبريء تشاكا من مسئولية خروج سويسرا من اليورو</a></h3>
          <p class="text-muted"><span>٢٤ ديسمبر / بواسطة: <a href="#">فريق كورة لايف</a> / القسم: <a href="#">كرة عربية</a> / <a href="#">٣ تعليقات</a></span></p>
          <a href="post-details.html">
          <figure><img alt="" src="images/post-img.jpg" class="img-responsive"></figure>
          </a>
          <p><strong>هذا النص</strong> هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى <del>أن يطلع على صورة حقيقية لتصميم الموقع.</del> ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملاً،دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.</p>
          <blockquote>
