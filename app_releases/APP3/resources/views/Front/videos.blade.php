...
<title>كورة لايف - كل الفيديوهات</title>
    ...
    <div class="col-sm-12">
      <div id="video-info" class="row">
        <div class="box-body col-sm-4">
          <div class="bordered padding-all"> <a class="details" href="index.html" >
            <figure title="<h3 class='text-uppercase text-info'>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              ...
              <h3 class="text-uppercase text-info">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              <div  class="vid-box"> <i class="icofont icofont-ui-play"></i><img class="img-responsive" alt="" src="images/slide-img-1.jpg"> </div>
            </figure>
            </a>
        ...
        <div class="box-body col-sm-4">
          <div class="bordered padding-all"> <a class="details" href="index.html" >
            <figure title="<h3 class='text-uppercase text-info'>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
                    <p>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>">
              <h3 class="text-uppercase text-info">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              <div  class="vid-box"> <i class="icofont icofont-ui-play"></i><img class="img-responsive" alt="" src="images/slide-img-2.jpg"> </div>
            </figure>
            </a>
            <div class="box-sub-info">
              <ul class="list-inline no-padding-right text-primary row">
        ...
        <div class="box-body col-sm-4">
          <div class="bordered padding-all"> <a class="details" href="index.html" >
            <figure title="<h3 class='text-uppercase text-info'>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
                    <p>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>">
              <h3 class="text-uppercase text-info">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              <div  class="vid-box"> <i class="icofont icofont-ui-play"></i><img class="img-responsive" alt="" src="images/slide-img-3.jpg"> </div>
            </figure>
            </a>
            <div class="box-sub-info">
              <ul class="list-inline no-padding-right text-primary row">
        ...
        <div class="box-body col-sm-4">
          <div class="bordered padding-all"> <a class="details" href="index.html" >
            <figure title="<h3 class='text-uppercase text-info'>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
                    <p>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>">
              <h3 class="text-uppercase text-info">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              <div  class="vid-box"> <i class="icofont icofont-ui-play"></i><img class="img-responsive" alt="" src="images/slide-img-4.jpg"> </div>
            </figure>
            </a>
            <div class="box-sub-info">
              <ul class="list-inline no-padding-right text-primary row">
        ...
        <div class="box-body col-sm-4">
          <div class="bordered padding-all"> <a class="details" href="index.html" >
            <figure title="<h3 class='text-uppercase text-info'>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
                    <p>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>">
              <h3 class="text-uppercase text-info">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              <div  class="vid-box"> <i class="icofont icofont-ui-play"></i><img class="img-responsive" alt="" src="images/slide-img-5.jpg"> </div>
            </figure>
            </a>
            <div class="box-sub-info">
              <ul class="list-inline no-padding-right text-primary row">
        ...
        <div class="box-body col-sm-4">
          <div class="bordered padding-all"> <a class="details" href="index.html" >
            <figure title="<h3 class='text-uppercase text-info'>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
                    <p>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>">
              <h3 class="text-uppercase text-info">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              <div  class="vid-box"> <i class="icofont icofont-ui-play"></i><img class="img-responsive" alt="" src="images/slide-img-6.jpg"> </div>
            </figure>
            </a>
            <div class="box-sub-info">
              <ul class="list-inline no-padding-right text-primary row">
        ...
        <div class="col-sm-12 text-center ad"><img class="img-responsive" src="images/ad-728-90.jpg" width="728" height="90" alt=""/></div>
        <div class="box-body col-sm-4">
          <div class="bordered padding-all"> <a class="details" href="index.html" >
            <figure title="<h3 class='text-uppercase text-info'>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
                    <p>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>">
              <h3 class="text-uppercase text-info">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              <div  class="vid-box"> <i class="icofont icofont-ui-play"></i><img class="img-responsive" alt="" src="images/slide-img-7.jpg"> </div>
            </figure>
            </a>
            <div class="box-sub-info">
              <ul class="list-inline no-padding-right text-primary row">
        ...
        <div class="box-body col-sm-4">
          <div class="bordered padding-all"> <a class="details" href="index.html" >
            <figure title="<h3 class='text-uppercase text-info'>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
                    <p>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>">
              <h3 class="text-uppercase text-info">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              <div  class="vid-box"> <i class="icofont icofont-ui-play"></i><img class="img-responsive" alt="" src="images/slide-img-8.jpg"> </div>
            </figure>
            </a>
            <div class="box-sub-info">
              <ul class="list-inline no-padding-right text-primary row">
                <li class="col-sm-4"><a class="btn btn-sm btn-default btn-block" href="#"><i class="icofont icofont-calendar"></i>19 ديسمبر 2016</a></li>
                <li class="col-sm-4"><a class="btn btn-sm btn-default btn-block" href="#"><i class="icofont icofont-eye-alt"></i>21 مشاهدة</a></li>
                <li class="col-sm-4"><a class="btn btn-sm btn-default btn-block" href="#"><i class="icofont icofont-speech-comments"></i>4 تعليقات</a></li>
              </ul>
            </div>
        ...
        <div class="box-body col-sm-4">
          <div class="bordered padding-all"> <a class="details" href="index.html" >
            <figure title="<h3 class='text-uppercase text-info'>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
                    <p>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.</p>">
              <h3 class="text-uppercase text-info">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</h3>
              <div  class="vid-box"> <i class="icofont icofont-ui-play"></i><img class="img-responsive" alt="" src="images/slide-img-9.jpg"> </div>
            </figure>
            </a>
            <div class="box-sub-info">
              <ul class="list-inline no-padding-right text-primary row">
...
<script src="js/ar-sa.js"></script> 
<script src="js/bootsnav.js"></script> 
<script src="js/owl.carousel.min.js"></script> 
<script src="js/hammer.min.js"></script> 
<script src="js/count-down.js"></script> 
<script src="js/nicescroll.min.js"></script> 
<script src="js/sliphover.js"></script>
