			...
			<a href="#" ><i class="fa fa-dashboard"></i> Admin panel</a>
			 ...
			 <div class="toggle">
				...
				<span class="tog" style="color: white; margin-left: 15px;">
					...
					<a href="#" style="color: rgb(255, 255, 255);"><i class="fa fa-chevron-down" style="color: rgb(88, 92, 100); padding-right: 15px;"  aria-hidden="true"></i>Match</a>

				 </span>

				<ul class="ts-sidebar-menu">

	<li><a href="{{ url('reserve_player') }}"><i class="fa fa-minus"></i> Reserve players</a></li>

	<li><a href="{{ url('player_match') }}"><i class="fa fa-minus"></i> Principle players</a></li>

	<li><a href="{{ url('change_player') }}"><i class="fa fa-minus"></i> Changes</a></li>
...
<div class="toggle">
 ...
 <span class="tog" style="color: white; margin-left: 15px;">
	 ...
	 <a href="#" style="color: rgb(255, 255, 255);"><i class="fa fa-chevron-down" style="color: rgb(88, 92, 100); padding-right: 15px;"  aria-hidden="true"></i>مباريات اليوم</a>
...
<li><a href="{{ url('now',$matchdetail->match_id) }}"><i class="fa fa-minus"></i>{{ $matchdetail->T1name }} - {{ $matchdetail->T2name }}</a></li>
 ...
 <div class="toggle">
  ...
  <span class="tog" style="color: white; margin-left: 15px;">
 	 ...
 	 <a href="#" style="color: rgb(255, 255, 255);"><i class="fa fa-chevron-down" style="color: rgb(88, 92, 100); padding-right: 15px;"  aria-hidden="true"></i>Analysis</a>

 	</span>

  <ul class="ts-sidebar-menu ">

 	 <li><a href="{{ url('analysis') }}"><i class="fa fa-minus"></i> Analysis</a></li>
...
<div class="toggle">
 ...
 <span class="tog" style="color: white; margin-left: 15px;">
	 ...
	 <a href="#" style="color: rgb(255, 255, 255);"><i class="fa fa-chevron-down" style="color: rgb(88, 92, 100); padding-right: 15px;"  aria-hidden="true"></i>News</a>

	</span>

 <ul class="ts-sidebar-menu ">

	 <li><a href="{{ url('snew') }}"><i class="fa fa-minus"></i> News</a></li>
