...
<body><div class="row">
      ...
      <div class="col-sm-12 text-center ad-con"> <img class="img-responsive" src="/admin-ui/images/728-90-ad.gif"/> </div>

      </div>

<div class="body-container">

<div id="RightFloatAds" ><img src="admin-ui/images/ad.gif"/> </div>

<div id="LeftFloatAds" ><img src="admin-ui/images/ad.gif"/> </div>
  ...
  <nav class="mash-menu" data-color="">
    ...
    <section class="mash-menu-inner-container"> 
      ...
      <ul class="mash-brand">
        ...
        <li> <a href="#"><span>Koralife</span> </a> 
      ...
      <ul class="mash-list-items" style="float:right;">
        ...
        <li style="float:right;"><a style="font-size: 14px;font-weight: bold;" href="#"> المنتخبات <i class="fa fa-caret-down fa-indicator"></i>
