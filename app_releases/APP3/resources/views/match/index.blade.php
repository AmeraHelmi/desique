    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="addModalLabel"><i class="fa fa-plus-circle"></i>أضافة ماتش</h4>
            </div>
            <form role="form" method="POST" class="addForm" action="{{ url('/match/store') }}" data-toggle="validator" enctype="multipart/form-data" >
