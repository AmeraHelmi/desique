...
<a class="ajax-link" href="{{ url('g_album') }}">
    ...
    <span> الالبوم</span></a>
        ...
        <ul class="nav nav-pills nav-stacked">
            ...
            <li class="accordion">
        <a href="#"><i class="glyphicon glyphicon-plus"></i><span> اللاعب</span></a>
        <ul class="nav nav-pills nav-stacked">
            ...
            <li><a href="{{ url('player_sponsor') }}">الرعاه للاعب</a></li>
                ...
                <li class="accordion">
        <a href="#"><i class="glyphicon glyphicon-plus"></i><span> البطولات</span></a>
        <ul class="nav nav-pills nav-stacked">
        ...
        <ul class="nav nav-pills nav-stacked">
            ...
            <li><a href="{{ url('agent_history') }}">تاريخ الوكلاء</a></li>
                                    ...
                                    <li class="accordion">
        <a href="#"><i class="glyphicon glyphicon-plus"></i><span> المديرين</span></a>
        <ul class="nav nav-pills nav-stacked">
            <li><a href="{{ url('manager') }}"> اضافة مدير </a></li>
            <li><a href="{{ url('managment_championship') }}">بطولات المديرين</a></li>
        </ul>
    </li>
...
<a class="ajax-link" href="{{ url('sponsor') }}"><i class="glyphicon glyphicon-arrow-left"></i><span> الرعاه</span></a>
    ...
    <li>
<a class="ajax-link" href="{{ url('channel') }}"><i class="glyphicon glyphicon-arrow-left"></i><span> القنوات الرياضيه</span></a>
</li>

    <li>
<a class="ajax-link" href="{{ url('commentor') }}"><i class="glyphicon glyphicon-arrow-left"></i><span> المعلقون</span></a>
</li>


    <li>
<a class="ajax-link" href="{{ url('stadium') }}"><i class="glyphicon glyphicon-arrow-left"></i><span> الاستادات</span></a>
</li>

    <li>
<a class="ajax-link" href="{{ url('shoe') }}"><i class="glyphicon glyphicon-arrow-left"></i><span> الاحذيه</span></a>
</li>

    <li>
<a class="ajax-link" href="{{ url('branch') }}"><i class="glyphicon glyphicon-arrow-left"></i><span> فروع النادى</span></a>
</li>

                                    <li class="accordion">
        <a href="#"><i class="glyphicon glyphicon-plus"></i><span> المدربين</span></a>
        <ul class="nav nav-pills nav-stacked">
