...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="name" placeholder="ادخل اسم المنتج" required class="form-control">
...
<div class="form-group">
    ...
    <input type="number" class="form-control" name="price"  required class="form-control">
    <span class="help-block with-errors errorName"></span>
</div>
