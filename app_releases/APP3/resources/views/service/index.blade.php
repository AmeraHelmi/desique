            ...
            <br>
                ...
                <ul class="alerts-list" style="display:none;" id="show">
                    <li>
                        <div class="alert alert-success alert-dismissable">
                            <i class="icon-remove-sign"></i> تم أضافة الخدمة بنجاح.
                ...
                <ul class="alerts-list" style="display:none;" id="showupdate">
                  ...
                  <a class="btn btn-primary" data-toggle="modal" data-target="#addModal" style="margin-bottom:20px;" >
		                  <i class="fa fa-plus-circle" style="font-size: 18px;"></i> اضافة خدمة
                  </a>
                          ...
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="addModalLabel"><i class="fa fa-plus-circle"></i> Add service</h4>
                                  </div>
                                  <form role="form"  method="POST" class="addForm" action="{{ url('/service/store') }}" data-toggle="validator"  enctype="multipart/form-data" >
                      ...
                      <div class="modal fade" id="editcountryModal" tabindex="-1" role="dialog" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
                          <div class="modal-dialog">
                              <div class="modal-content">
                                  ...
                                  <form role="form"  method="POST" class="editForm" data-id="" action="{{ url('/service/update') }}" data-toggle="validator" enctype="multipart/form-data">
                                      <div class="modal-body">
                                        @include('service.form')
                                      </div>
                                      <div class="modal-footer">
		...
		function populateForm(response, frm)
    {
       ...
       //Edit Form
           ...
           $('.editForm')[0].reset();
		         ...
		         self.button('loading');
		         $.ajax({
		             url: "{{ url('service') }}" + "/" + self.data('id') + "/edit" ,
		             type: "GET",
		             success: function(res){
		                 self.button('reset');
